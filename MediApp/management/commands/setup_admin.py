...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        admin_user.email = os.environ.get('EMAIL_HOST_USER', 'sharmaneeraj3415@gmail.com')
        ...
        admin_user.save()
        self.stdout.write(self.style.SUCCESS(f"Admin user 'admin' (password: Neeraj@600666) is ready."))
